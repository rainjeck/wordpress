...
class Enqueue
{
  ...
  public function enqueueScripts()
  {
    ...
    if ($dev) {
      ...
      wp_enqueue_style( 'app', "{$url}/assets/css/app.css", array('main'), null, 'all' );
    ...
    if (!$dev) {
      wp_enqueue_style( 'app', "{$url}/assets/css/bundle.min.css", array(), null, 'all' );
      wp_enqueue_script( 'app', "{$url}/assets/js/bundle.min.js", array(), null, true );
    }
